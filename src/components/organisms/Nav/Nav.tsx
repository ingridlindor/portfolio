...
export default function Nav() {
  return (
    <nav className="sticky top-0 z-50 border-b-2 border-retro-yellow bg-retro-bg flex justify-between items-stretch px-4 md:px-6">
      {/* Logo */}
      <div className="flex items-center py-4">
        <span className="font-['VT323'] text-[1.7rem] text-[var(--yellow)] tracking-wider" style={{ textShadow: '2px 2px 0 #996600' }}>
